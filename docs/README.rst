...
The F5 OpenStack Heat Plugins are a set of `OpenStack Heat Resource Plugins`_.
...
The F5 Heat plugins define objects used in OpenStack Heat templates to orchestrate F5 services.
...
See the `F5 OpenStack Heat template library`_ and the `F5 OpenStack Heat documentation`_.

.. _OpenStack Heat Resource Plugins: https://docs.openstack.org/developer/heat/developing_guides/pluginguide.html
.. _F5 OpenStack Heat documentation: /cloud/openstack/heat/latest/
.. _F5 OpenStack Heat template library: /products/templates/openstack-heat/
